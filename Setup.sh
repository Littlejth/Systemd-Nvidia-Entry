...
install(){
	...
	printf " modprobe.blacklist=nvidia,nvidia_drm,nvidia_modeset,nvidia_uvm,nouveau rd.blacklist.driver=nouveau" | sudo tee -a /etc/kernel/cmdline.d/40_switch_nvidia.conf
}
